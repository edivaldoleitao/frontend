...
const FilterBar = ({ onFilterChange }: FilterBarProps) => {
  const filters = [
    ...
    { label: "Site", key: "seller", hasDropdown: true, options: ["Kabum", "Amazon"] },
    { label: "Avaliação", key: "rating", hasDropdown: true, options: ["5", "4", "3"] },
    { label: "Marca", key: "brand", hasDropdown: true, options: ["ASUS", "MSI", "Biostar"] },
    { label: "Modelo", key: "model", hasDropdown: true, options: ["B550", "A520"] }
  ];

  return (
    <div className="p-4">
      <div className="container mx-auto w-full flex items-center space-x-4 flex-nowrap">
